...
from mash.helpers.commands import CommandTemplates, CommandReference
...
class LLMClient:
    SYSTEM_PROMPT = (
        ...
        f"Available command templates:\n{CommandTemplates.TEMPLATES_LIST}\n\n"
        f"Available shell commands:\n{CommandReference.COMMANDS_LIST}\n\n"
    ...
    def ask(
        ...
        except (ollama.ResponseError, ConnectionError, TimeoutError, OSError, ValueError, RuntimeError) as exception_from_ollama:
            raise LLMUnavailable("ollama.chat failed") from exception_from_ollama
